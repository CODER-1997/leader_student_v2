...
class StudentController extends GetxController {
  ...
  Future<void> fetchGroups() async {
    ...
    QuerySnapshot querySnapshot = await _firestore.collection('LeaderGroups').get();
    LeaderGroups.clear();
  ...
  void addNewStudent(String yearlyFee) async {
    ...
    try {
      StudentModel newData = StudentModel(
          ...
          studyDays: [], isFreeOfcharge: isFreeOfCharge.value, exams: [], yearlyFee: yearlyFee, );
...
// Firestore
  ...
  void recoverGroupName(String documentId,String groupName) async {
    isLoading.value = true;
  ...
  void addPayment(String documentId, String paidDate,String totalFee) async {
    ...
    if (payment.text.isNotEmpty) {
      try {
        ...
        // else{
        currentArray.add({
           'paidDate': paidDate.toString().isEmpty ? DateFormat('dd-MM-yyyy').format(DateTime.now()):paidDate,
           'totalFee':totalFee,
  ...
  TextEditingController howMany = TextEditingController();

  void addExam(String documentId, String examDate) async {
    isLoading.value = true;
    if (from.text.isNotEmpty && howMany.text.isNotEmpty) {
      try {
        // Retrieve the document reference
        DocumentReference documentReference = FirebaseFirestore.instance
            .collection('LeaderStudents')
        ...
        currentArray.add({
          ...
          'from': from.text,
          'howMany': howMany.text.removeAllWhitespace,
          'examDate': examDate,
          'id':generateUniqueId()
        });
        // }
